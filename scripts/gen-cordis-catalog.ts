...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  FamilyEntry: 'family mapping row is owned by packages/metacog/blockade/README.md',
  ProbeEntry: 'probe mapping row is owned by packages/metacog/blockade/README.md',
  Evidence: 'verification evidence record is owned by packages/metacog/blockade/README.md',
  BlockadeLessonStore: 'lesson store service is owned by packages/metacog/blockade/README.md',
  AgentLedger: 'per-agent attempt ledger is owned by packages/metacog/blockade/README.md',
