...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/metacog/blockade-sim': { kind: 'indirect', reason: 'The worlds register plain tools whose schemas they own; the PolicyAdapter replaces the model in keyless runs and adds no model-visible context.' },
